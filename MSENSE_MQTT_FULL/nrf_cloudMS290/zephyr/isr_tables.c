...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x38e1d, (ISR)0x487af}, /* 42 */
	...
	{(const void *)0x38c5d, (ISR)0x487af}, /* 49 */
