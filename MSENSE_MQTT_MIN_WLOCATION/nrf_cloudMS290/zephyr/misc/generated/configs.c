...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SAMPLE_REQUEST_INTERVAL_SECONDS, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOCATION_TRACKING_SAMPLE_INTERVAL_SECONDS, 10800);
