...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x39069, (ISR)0x488e1}, /* 42 */
	...
	{(const void *)0x38ea9, (ISR)0x488e1}, /* 49 */
