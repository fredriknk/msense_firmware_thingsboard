...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x38ccd, (ISR)0x4851b}, /* 42 */
	...
	{(const void *)0x38b0d, (ISR)0x4851b}, /* 49 */
