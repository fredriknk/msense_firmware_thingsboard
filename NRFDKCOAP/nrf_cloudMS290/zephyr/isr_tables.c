...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x38d15, (ISR)0x484e5}, /* 42 */
	...
	{(const void *)0x38b55, (ISR)0x484e5}, /* 49 */
