...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x3919d, (ISR)0x48a15}, /* 42 */
	...
	{(const void *)0x38fdd, (ISR)0x48a15}, /* 49 */
