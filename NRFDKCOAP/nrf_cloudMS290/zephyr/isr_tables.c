...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x38da9, (ISR)0x48579}, /* 42 */
	...
	{(const void *)0x38be9, (ISR)0x48579}, /* 49 */
