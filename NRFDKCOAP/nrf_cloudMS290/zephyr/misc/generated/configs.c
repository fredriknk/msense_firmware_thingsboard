...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOCATION_TRACKING_SAMPLE_INTERVAL_SECONDS, 360);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_FOTA_JOB_CHECK_RATE_MINUTES, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_FOTA_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SHADOW, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SHADOW_CHECK_RATE_SECONDS, 120);
